...
Here is the original image I want you to look at:
...
Look at the original image and the scene description in your system prompt. Based on both, rewrite the angle template into a specific image-to-image reframing prompt.
...
- Include any character sheet reference notes from the scene description
